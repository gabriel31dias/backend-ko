...
async function main() {
    ...
    for (let i = 0; i < 1000; i++) {
        ...
        const transaction = {
            ...
            expiresAt: new Date(createdAt.getTime() + 2 * 24 * 60 * 60 * 1000),
            ...
            fixedFeeApplied: status === 'approved' ? Math.floor(Math.random() * 300) / 100 : null,
            percentageFeeApplied: status === 'approved' ? Math.floor(Math.random() * 500) / 100 : null,

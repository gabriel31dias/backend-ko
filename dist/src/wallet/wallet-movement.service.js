    ...
    async getStatement(userId, options) {
        ...
        const enhancedMovements = movements.map(m => {
            ...
            if (domainMovement.category === 'transaction_fee' && (!domainMovement.description || !domainMovement.description.includes('Taxa de transação'))) {
                ...
                const percentageFeeAmount = ((_a = domainMovement.metadata) === null || _a === void 0 ? void 0 : _a.percentageFee) ||
                    (((_b = domainMovement.metadata) === null || _b === void 0 ? void 0 : _b.grossAmount) ? (domainMovement.metadata.grossAmount * effectiveFees.percentageFee) / 100 : 0);
